            ...
            <div className='about-wrapper'>
               <div className='about-text'>
                  ...
                  <div className='about-text-desc'>
                     <Text fontSize='3xl'>
                        Passionate <span className='name'>FULL STACK DEVELOPER</span>{' '}
                        with 5 years of experience in web development. Enthusiastic
                        about fun, cool, efficient technology solutions.
                     </Text>
                  </div>

                  <div className='icons'>
                     <a
                        href='https://github.com/fieldpalmer'
                        target='_blank'
                        rel='noreferrer'
                     >
