...
const Projects = () => {
  return(
    <div className="bg-projects">
      <p className="heading">Portfolio Selection</p>
      {/* <p className="text">Take a look at a few of my projects:</p> */}
      ...
      <div>
        ...
        <a href="https://github.com/fieldpalmer?tab=repositories" target="_blank" rel="noreferrer">
